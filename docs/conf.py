...
project = u'jams'
copyright = u'2014, Eric J. Humphrey, Justin Salamon, Oriol Nieto, Jon Forsyth, Rachel M. Bittner, Juan P. Bello'
...
import pyjams.version
version = pyjams.version.short_version
# The full version, including alpha/beta/rc tags.
release = pyjams.version.version
...
texinfo_documents = [
  ('index', 'jams', u'jams Documentation',
   u'Eric J. Humphrey, Justin Salamon, Oriol Nieto, Jon Forsyth, Rachel M. Bittner, Juan P. Bello', 'jams', 'One line description of project.',
   'Miscellaneous'),
]
